...
class SpotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spot" do
    assert_difference("Spot.count") do
      post spots_url, params: { spot: { acitve: @spot.acitve, category: @spot.category, comment: @spot.comment, location: @spot.location, user_id: @spot.user_id } }
    end
  ...
  test "should update spot" do
    patch spot_url(@spot), params: { spot: { acitve: @spot.acitve, category: @spot.category, comment: @spot.comment, location: @spot.location, user_id: @spot.user_id } }
